...
public class CaptchaImage {
    ...
    public static void main(String args) {
        String clientId = "6dX0qn36p3mTrVXiEGJq"; //애플리케이션 클라이언트 아이디값";
        String clientSecret = "1QEkPWzTbu"; //애플리케이션 클라이언트 시크릿값";

        String key = args; // https://openapi.naver.com/v1/captcha/nkey 호출로 받은 키값
