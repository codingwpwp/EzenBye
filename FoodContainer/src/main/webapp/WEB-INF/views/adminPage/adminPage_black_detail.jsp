            ...
            <div class="col-12 col-sm-9 col-md-10 col-lg-8">
                <article id="mainSection">
                    ...
                    <div class="ps-2">
                        ...
                        <button type="button" class="btn btn-secondary me-2">회원추방</button>
                        <button type="button" class="btn btn-dark" data-bs-toggle="modal" data-bs-target="#blackListModal">일반 회원으로 복귀</button>
                    </div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-header">
                                    <span class="modal-title fs-3 fw-bold" id="blackListModalLabel">일반회원으로 복귀하시겠습니까?</span>
                                    ...
                                    <div class="row d-flex align-items-center">
                                        ...
                                        <div class="col-12 d-flex align-items-center">
                                            ...
                                            <div class="col-9 col-sm-10">
                                                <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" maxlength="100" disabled>블랙사유</textarea>
                                            </div>
                                ...
                                <div class="modal-footer d-flex justify-content-start">
                                    <button type="button" class="btn btn-dark" data-bs-dismiss="modal">아니요</button>
