                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="staticBackdropLabel">일반회원으로 복귀하시겠습니까?</h5>
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="row d-flex align-items-center">
                                        ...
                                        <div class="col-10">
                                            <textarea class="form-control bg-warning bg-gradient bg-opacity-25" id="exampleFormControlTextarea1" rows="3">여자가 말대꾸해서</textarea>
                                        </div>
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-outline-dark" data-bs-dismiss="modal">아니요</button>
