      ...
      <nav class="nav flex-column left-nav nav-light bg-light" id="leftAside1">
        <div id="asdieMenu1">
			<p class="fs-5 nav-title">쇼핑정보</p>
	  		...
	  		<a class="nav-link active nav5 left-nav-text" aria-current="page" href="mypage_review.do?nowPage=1">나의 리뷰</a>
	  		<a class="nav-link nav6 left-nav-text" href="mypage_recipe.do">나의 레시피</a>
	  		<a class="nav-link nav7 left-nav-text" href="mypage_inquiries.do?nowPage=1">문의내역</a>
