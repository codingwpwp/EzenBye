                ...
                <article id="mainSection">
                   ...
                   <div class="container head">
						<div class="row head">
							...
							<div class="col-12">입력하신 정보와 일치하는 아이디는 다음과 같습니다.</div>
						</div>
					</div>
						...
						<div class="row checkfrm">
							<div class="col-md-12 col-sm-12 col-12">
								<form class="idcheck">
									<div class="container">
										<div class="row">
											<div class="col-md-12 col-sm-12 col-12 d-contents"
												id="emailcheck">
												<h3>
													홍길동님의 이메일로 <div><strong>임시 비밀번호</strong>를</div>발송 하였습니다.
												</h3>
											</div>
											<div class="col-md-12 col-sm-3 col-12">

												<input class="btn btn-dark login" value="로그인" type="button"
													onclick="location.href='<%=request.getContextPath()%>/loginmain.do'">
											</div>
										</div>
									</div>
								</form>
