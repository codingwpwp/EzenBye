                ...
                <article id="mainSection">
                    <!-- 실질적인 메인 내용 -->
                      <form action="#" method="post" id="recipewr">
                        <div class="container">
                            <div class="row">
                             <div class="col-sm-12 col-12 retitle">
                                 <h1>레시피 등록</h1>
                             </div>
                            </div>
                             <div class="row title">
                                 <div class="col-md-1 col-sm-3 col-2 ti">
                                  <strong>제목</strong>
                                 </div>
                              ...
                              <div class="row content">
                                <div class="col-md-1 col-sm-3 col-2"><strong>내용</strong></div>
                                 <div class="col-md-6 col-sm-7 col-10 mb-1 "><div id="summernote"></div></div>    
                                 <div class="col-md-3 col-sm-3  col-12 sumnail" id="sumnail"><a href="#" 
                             ...
                             <div class="row hap">
                                <div class="col-sm-2 col-12" id="hap"><strong>조합 상품</strong></div>    
                             
                                  <div class="col-sm-3 col-4 sel1" id="selbox"> 
                                 ...
                                 <div class="col-sm-3 col-4 sel2" id="selbox">
                                     <select name="" id="sel" class="select1">
                                 ...
                                 <div class="col-sm-3 col-4 sel3" id="selbox">
                                     <select name="" id="sel" class="select1">
